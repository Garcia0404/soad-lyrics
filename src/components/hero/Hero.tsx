...
export default function Hero() {
  return (
    <main className='overflow-hidden relative'>
      ...
      <h1 className='w-full h-full sm:mix-blend-difference absolute top-0 z-10 p-4 sm:p-10'>
        <picture className='w-full'>
          ...
          <img className='mx-auto w-full h-full object-contain' fetchPriority='high' src="imagen-movil-completa.jpg" alt="soad_logo" />
        </picture>
      </h1>
    </main>
  )
